...
parser.add_argument('--num_coll_time', nargs=2, help='number of collisions in given hour/day/month/year')
parser.add_argument('--safe_danger_time', nargs=2, help='safest or dangerous hour/day/month/year')
parser.add_argument('--max_coll_time', nargs=2, help='hour/day/month/year having maximums number of collisions')
